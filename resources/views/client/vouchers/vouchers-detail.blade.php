            ...
            <h3 class="title your-code">{{ $vouchers1->code }}</h3>
                        ...
                        <div class="col-md-4 button11">
                            @if ($vouchers1->status != 3 && $vouchers1->status != 4)
                                <button id="copy-button"
                                    style="background-image: -webkit-linear-gradient(169deg, #5560ff 17%, #aa52a1 63%, #ff4343 100%);"
                                    onclick="copyCode()">Sao chép mã</button>
                            @else
                                <button id="copy-button"
                                    style="background-image: -webkit-linear-gradient(169deg, #5560ff 17%, #aa52a1 63%, #ff4343 100%); display : none">Sao
                                    chép mã</button>
                            @endif
                        </div>
                    </div>
                    ...
                    {{-- <li>
                        ...
                        @elseif ($hoursRemaining < 24)
                            <span class="content">Sắp hết hạn còn {{ $hoursRemaining }} giờ {{ $minutesRemaining }}
                                phút</span>
                        @else
                            <span class="content">Hạn sử dụng đến
                                {{ \Carbon\Carbon::parse($vouchers1->end_date)->format('d/m/Y') }}</span>
                        @endif
                    ...
                    <div class="social-and-duration">
                        <div class="duration-area">
                            ...
                            {{-- <div class="item">
                                ...
                                <i class="fas fa-calendar-alt"></i><span>{{ $vouchers1->start_date }} -
                                    {{ $vouchers1->end_date }}</span>
                            </div> --}}
                    ...
                    <div class="social-and-duration">
                        <div class="duration-area">
                            ...
                            {{-- <div class="item">
                                <span>Ưu đãi <br> </span>
                                <span>Lượt sử dụng có hạn. Nhanh tay kẻo lỡ bạn nhé ! Giảm {{ $vouchers1->value }} Đơn Tối
                                    Thiểu {{ $vouchers1->min_order_amount }} Giảm tối đa
                                    {{ $vouchers1->max_order_amount }}</span>
                            </div> --}}
                        ...
                        <div class="duration-area">
                            ...
                            <div class="item">
                                ...
                                <span>Áp dụng cho một số sản phẩm và người dùng nhất định trên Boleto.
                                    ...
                                    thị nếu nằm trong danh sách sản phẩm đã chọn.Tìm hiểu thêm.</span>
                            </div>
