                ...
                <div class="table-responsive">
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <form action="{{ route('movie.trash') }}" method="get">
                                    <div class="row">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                           href="{{ route('movie.restore',['id' => $movie->id]) }}">Khôi phục</a>
                                                        <a class="dropdown-item show_confirm"
                                                           href="{{ route('movie.delete',['id' => $movie->id]) }}">Xóa vĩnh viễn</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
        ...
        function updateStatus() {
            $(document).ready(function () {
                $('.switch-status').change(function () {
                    ...
                    $.ajax({
                        method: 'POST',
                        url: '/admin/movie/update-status/' + itemId,
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: status
                        },
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/movie/restoreSelected',
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/movie/permanentlyDeleteSelected', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
