...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Danh sách đánh giá phim</h1>
                    ...
                    <div class="col text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('feed-back.trash') }}">Thùng rác</a>
                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <form action="{{ route('feed-back.index') }}" method="get">
                                    <div class="row">
                                        <div class="col-3">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item show_confirm"
                                                           href="{{ route('feed-back.destroy',['id' => $feedback->id]) }}">Xóa</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
        ...
        function alertConfirmation() {
            $('.show_confirm').click(function (event) {
                ...
                swal({
                    ...
                    text: "Nếu bạn xóa, Nó sẽ được đưa vào thùng rác.",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
            ...
            $(document).ready(function () {
                $('#delete-selected').click(function (e) {
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            title: 'Xác nhận xóa',
                            text: 'Bạn có chắc chắn muốn xóa các đánh giá đã chọn?',
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/feed-back/deleteAll', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
