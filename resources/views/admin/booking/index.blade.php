                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item "
                                                                href="{{ route('booking.detail', ['id' => $value->id]) }}">Chi
                                                                tiết
                                                            </a>
                                                            @if ($value->status == 2)
                                                                ...
                                                                <a class="dropdown-item" href="#" data-toggle="modal"
                                                                    data-target="#cancelOrderModal">Huỷ
                                                                    đơn
                                                                </a>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <button type="button " class="close "
                                                                style="border:none; background:none" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="{{ route('booking.cancel', $value->id) }}"
                                                                method="POST">
                                                                @csrf
