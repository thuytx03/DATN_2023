...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">    Trả lời Bình Luận</h1>
                    ...
                    <div class="col text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('reply.trash') }}">Thùng rác</a>
                ...
                <div class="table-responsive">
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                           ...
                           <form action="{{ route('reply.index') }}" method="get">
                        <div class="row">
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('reply.destroy', ['id' => $reply->id]) }}" class="dropdown-item
                                    ...
                                    <form action="{{ route('reply.destroy', ['id' => $reply->id]) }}" method="post" id="delete">
                                        @csrf
                                    </form>
                            </td>
                        </tr>
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/reply/deleteAll', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
