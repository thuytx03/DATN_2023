...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Thùng rác quyền</h1>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach($softDeletedPermission as $softDeletedPermission)
                                    <tr class="">
                                        <td>
                                            <input type="checkbox" class="child-checkbox" value="{{ $softDeletedPermission->id }}" name="id">
                                        </td>
                                        <td>{{$softDeletedPermission->name}}</td>
                                        <td>{{$softDeletedPermission->display_name}}</td>
                                        <td>{{$softDeletedPermission->group}}</td>
                                        <td class="col-1">
                                            <div class="dropdown">
