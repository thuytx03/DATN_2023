...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Danh sách lịch chiếu</h1>
                ...
                <div class="table-responsive">
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <form action="{{ route('show-time.index') }}" method="get">
                                    <div class="row">
                                        <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
                                    Hiển thị {{ $showTimes->firstItem() }} đến {{ $showTimes->lastItem() }}
                                    của {{ $showTimes->total() }} mục
                                </div>
                            </div>
        ...
        function updateStatus() {
            $(document).ready(function() {
                $('.switch-status').change(function() {
                    ...
                    $.ajax({
                        method: 'POST',
                        url: '/admin/show-time/update-status/' + itemId,
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: status
                        },
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/show-time/deleteAll', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
