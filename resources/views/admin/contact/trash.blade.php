...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Thùng rác thư</h1>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ route('contact.restore', ['id' => $value->id]) }}">Khôi phục mục đã chọn</a>

                                                            <a class="dropdown-item show_confirm"
                                                                href="{{route('contact.permanentlyDelete',['id' => $value->id] )}}">Xoá vĩnh viễn
                                                            </a>
        ...
        function updateStatus() {
            ...
            $(document).ready(function() {
                $('.switch-status').change(function() {
                    ...
                    $.ajax({
                        method: 'POST',
                        url: 'contact/update-status/' + itemId,
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: status
                        },
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/contact/permanentlyDeleteSelected', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/contact/restoreSelected',
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
