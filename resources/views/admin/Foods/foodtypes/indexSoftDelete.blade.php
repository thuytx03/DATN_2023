...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Thung Rac</h1>
                    ...
                    <div class="col text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="#" id="delete-selected1" class="dropdown-item">Xoá đã chọn</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered dataTable no-footer" id="dataTable" width="100%"
                                    ...
                                    @foreach($Foodstypes1 as $listTyoes)
                                    <tr class="odd">
                                        ...
                                        <td class="text-center">
                                            ...
                                            if ($listTyoes->parent_id) {
                                                ...
                                                while ($currentCategoryId) {
                                                    $parentCategory = $Foodstypes1->where('id', $currentCategoryId)->first();
                                                    if ($parentCategory) {
                                        ...
                                        {{ implode(' > ', array_reverse($parentNames)) }}
                                        </td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('food_types.destroyTrash', ['id' => $listTyoes->id]) }}">xóa hoàn toàn</a>
                                                        <a class="dropdown-item show_confirm"
                                                            href="{{ route('food_types.unTrash', ['id' => $listTyoes->id]) }}">Khôi Phục
                                                        </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
                                    <ul class="pagination">
                                        {{ $Foodstypes1->links('pagination::bootstrap-4') }}
                                    </ul>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function deleteSelected() {
            $(document).ready(function() {
                $('#delete-selected1').click(function(e) {
                    e.preventDefault();
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/food_types/permanentlyDeleteSelected', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/food_types/unTrashAll',
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
