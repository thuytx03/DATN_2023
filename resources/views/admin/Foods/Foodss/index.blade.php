                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <th class="sorting text-center" tabindex="0" aria-controls="dataTable" rowspan="1"
                                    colspan="1" aria-label="ảnh: activate to sort column ascending"
                                    style="width: 82.2px;">Trạng Thái Sản Phẩm
                                </th>
                                            <th class="sorting text-center" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item show_confirm"
                                                            href="{{ route('movie-foode.destroy', ['id' => $value->id]) }}">Xoá
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/movie-food/deleteAll', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
