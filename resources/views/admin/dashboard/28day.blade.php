...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Thống kê hóa đơn 28 ngày gần đây</h1>
        <div class="">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalConfirmedAmountThisTwentyEight}} Vnđ</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalBookingsThisTwentyEight}}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Doanh thu 28 ngày gần đây</h6>
...
<script>
    $(document).ready(function() {
        $.ajax({
            url: '/admin/dashboard/invoice/day/getCountStatusTwentyEight',
            method: 'GET',
            success: function(response) {
