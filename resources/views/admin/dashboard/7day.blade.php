...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Thống kê hóa đơn 7 ngày gần đây</h1>
        <div class="">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalConfirmedAmountSevenDay}} Vnđ</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalBookingsThisSevenDay}}</div>
                        </div>
                        <div class="col-auto">
...
<script>
    $(document).ready(function() {
        $.ajax({
            url: '/admin/dashboard/invoice/day/getCountStatusSeven',
            method: 'GET',
            success: function(response) {
