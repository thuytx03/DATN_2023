                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalConfirmedAmountThisWeek}} Vnđ</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalBookingsThisWeek}}</div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Chưa xác nhận
                        </span>
                        <span class="mr-2">
...
<script>
    // Sử dụng AJAX để gọi API từ phía client
    $.ajax({
        url: '/admin/dashboard/invoice/week/weekly-data',
        type: 'GET',
        success: function(data) {
            ...
            if (Array.isArray(data)) {
                ...
                var daysOfWeek = ['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'T8'];
...
<script>
    $(document).ready(function() {
        $.ajax({
            url: '/admin/dashboard/invoice/week/getCountStatusWeek',
            method: 'GET',
