...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Danh sách ghế</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row align-items-center">
                <div class="col">
                    <a href="{{ route('seat.store') }}" class="btn btn-success">
                        Thêm mới
                    </a>
                </div>
            ...
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <form action="{{route('seat.index')}}" method="GET">
                                <div class="row">
                            ...
                            <table class="table table-bordered text-center mt-2" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$value->cinema->province->name}}</td>
                                        <td>{{$value->cinema->name}}</td>
                                        <td>{{$value->name}}</td>
                                        <td>{{$value->seat_count}}</td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @endif
                                                    <a class="dropdown-item show_confirm" href="{{route('seat.destroy',['id'=>$value->id])}}">Xoá
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                ...
                if (selectedCheckboxes.length > 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: 'POST',
                                url: '/admin/seat/deleteAll', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                data: {
                                    ids: selectedIds,
                                    _token: '{{ csrf_token() }}',
                                },
