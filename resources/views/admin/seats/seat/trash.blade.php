...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Thùng rác loại ghế</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row align-items-center">
                <div class="col">
                    <a href="{{ route('seat-type.index') }}" class="btn btn-success">
                        Danh sách loại ghế
                    </a>
                </div>
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td>
                                            <input type="checkbox" class="child-checkbox" value="{{ $value->id }}" name="id">
                                        </td>
                                        <td>{{$value->name}}</td>
                                        <td>{{$value->description}}</td>
                                        <td><img src="{{ $value->image?''.Storage::url($value->image):''}}" alt="" width="80px"></td>
                                        <td class="col-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('seat-type.restore', ['id' => $value->id]) }}">Khôi phục</a>

                                                    <a class="dropdown-item show_confirm" href="{{ route('seat-type.permanentlyDelete', ['id' => $value->id]) }}">Xoá vĩnh viễn
                                                    </a>
                ...
                if (selectedCheckboxes.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/admin/seat-type/permanentlyDeleteSelected', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                data: {
                                    ids: selectedIds,
                                    _token: '{{ csrf_token() }}',
                                },
                ...
                if (selectedCheckboxes.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/admin/seat-type/restoreSelected',
                                data: {
                                    ids: selectedIds,
                                    _token: '{{ csrf_token() }}',
                                },
