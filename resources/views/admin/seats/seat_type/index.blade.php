        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row align-items-center">
                    <div class="col">
                        <a href="{{ route('seat-type.store') }}" class="btn btn-success">
                            Thêm mới
                        </a>
                    </div>
                    <div class="col text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('seat-type.trash') }}">Thùng rác</a>
                ...
                <div class="table-responsive">
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <form action="{{ route('seat-type.index') }}" method="GET">
                                    <div class="row">
                                    ...
                                    <tbody>
                                        @foreach ($seatType as $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->name }}</td>
                                                <td><img src="{{ $value->image ? Storage::url($value->image) : asset('images/image-not-found.jpg') }}"
                                                        alt="" width="80px"></td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input type="checkbox" value="{{ $value->status }}" name="status"
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ route('seat-type.update', ['id' => $value->id]) }}">Sửa</a>
                                                            <a class="dropdown-item show_confirm"
                                                                href="{{ route('seat-type.destroy', ['id' => $value->id]) }}">Xoá
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        function updateStatus() {
            ...
            $(document).ready(function() {
                $('.switch-status').change(function() {
                    ...
                    $.ajax({
                        method: 'POST',
                        url: '/admin/seat-type/update-status/' + itemId,
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: status
                        },
                    ...
                    if (selectedCheckboxes.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/admin/seat-type/deleteAll', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                    data: {
                                        ids: selectedIds,
                                        _token: '{{ csrf_token() }}',
                                    },
