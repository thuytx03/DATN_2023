...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Thêm mới quốc gia </h1>
    @if (session('success'))
    ...
    <form action="{{ route('country.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3 mt-3">
            <label for="inputText" class="col-sm-2 col-form-label">Tên quốc gia <span class="text-danger">(*)</span></label>
            <div class="col-sm-10">
                <input type="text" name="name" placeholder="Vui lòng nhập tên quốc gia" class="form-control" value="{{ old('name') }}">
            </div>
        </div>
        ...
        <div class="row mb-3 mt-3">
            <label for="inputText" class="col-sm-2 col-form-label">Trạng thái <span class="text-danger">(*)</span></label>
            <div class="col-sm-10">
