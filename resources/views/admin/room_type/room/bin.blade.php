...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Thùng rác phòng</h1>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach($softDeletedRoom as $softDeletedRoom)
                                    <tr class="">
                                        <td>
                                        ...
                                        <td>
                                            @if($softDeletedRoom->typeRoom)
                                            {{$softDeletedRoom->typeRoom->name}}
                                            @else
                                        ...
                                        <td>{{$softDeletedRoom->cinema_id}}</td>
                                        <td class="col-1">
                                            <div class="dropdown">
