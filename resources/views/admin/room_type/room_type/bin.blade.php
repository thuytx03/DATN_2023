...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Thùng rác loại phòng</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row align-items-center">
                <div class="col">
                    <a href="{{ route('room-type.list') }}" class="btn btn-success">
            ...
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <form action="{{ route('bin.list-room-type') }}" method="get">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach($softDeletedRoomType as $softDeletedRoom)
                                    <tr class="">
                                        <td>
                                            <input type="checkbox" class="child-checkbox" value="{{ $softDeletedRoom->id }}" name="id">
                                        </td>
                                        <td>{{$softDeletedRoom->name}}</td>
                                        <td>{{$softDeletedRoom->description}}</td>
                                        <td><img src="{{ $softDeletedRoom->image?''.Storage::url($softDeletedRoom->image):''}}" alt="" width="80px"></td>
                                        <td class="col-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('bin.restore-room-type', ['id' => $softDeletedRoom->id]) }}">Khôi phục mục đã chọn</a>

                                                    <a class="dropdown-item show_confirm" href="{{ route('bin.delete-room-type', ['id' => $softDeletedRoom->id]) }}">Xoá vĩnh viễn
                                                    </a>
                ...
                if (selectedCheckboxes.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/admin/room-type/permanentlyDeleteSelected', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                data: {
                                    ids: selectedIds,
                                    _token: '{{ csrf_token() }}',
                                },
                ...
                if (selectedCheckboxes.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/admin/room-type/restoreSelected',
                                data: {
                                    ids: selectedIds,
                                    _token: '{{ csrf_token() }}',
                                },
