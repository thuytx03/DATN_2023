    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row align-items-center">
                <div class="col">
                    <a href="{{ route('form-add-room-type') }}" class="btn btn-success">
                        Thêm mới
                    </a>
                </div>
                <div class="col text-right">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('list-bin-room-type')}}">Thùng rác</a>
            ...
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <form action="{{route('list-room-type')}}" method="GET">
                                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{route('form-update-room-type',['id'=>$rooms->id])}}">Cập nhật</a>
                                                    <a class="dropdown-item show_confirm" href="{{route('delete-room-type',['id'=>$rooms->id])}}">Xoá
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
    ...
    function updateStatus() {
        ...
        $(document).ready(function() {
            $('.switch-status').change(function() {
                ...
                $.ajax({
                    method: 'POST',
                    url: '/admin/update/status/room/type/' + itemId,
                    data: {
                        _token: '{{ csrf_token() }}',
                        status: status
                    },
                ...
                if (selectedCheckboxes.length > 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: 'POST',
                                url: '/admin/delete/all/room/type', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                data: {
                                    ids: selectedIds,
                                    _token: '{{ csrf_token() }}',
                                },
