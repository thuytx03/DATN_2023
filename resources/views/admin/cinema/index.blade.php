...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Danh sách rạp phim</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row align-items-center">
                <div class="col">
                    <a href="{{ route('cinema.add') }}" class="btn btn-success">
                        Thêm mới
                    </a>
                </div>
                <div class="col text-right">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('cinema.trash') }}">Thùng rác</a>
            ...
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <form action="{{ route('cinema.index') }}" method="get">
                                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('cinema.edit', ['id' => $cinema->id]) }}">Sửa</a>
                                                    <a class="dropdown-item show_confirm" href="{{ route('cinema.destroy', ['id' => $cinema->id]) }}">Xoá
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-5 mb-3
                            ...
                            <div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
                                Hiển thị {{ $cinema1->firstItem() }} đến {{ $cinema1->lastItem() }}
                                của {{ $cinema1->total() }} mục
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-7">
                            <div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
                                <ul class="pagination">
                                    {{ $cinema1->links('pagination::bootstrap-4') }}
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    function updateStatus() {
        ...
        $(document).ready(function() {
            $('.switch-status').change(function() {
                ...
                $.ajax({
                    method: 'POST',
                    url: '/admin/cinema/update-status/' + itemId,
                    data: {
                        _token: '{{ csrf_token() }}',
                        status: status
                    },
                ...
                if (selectedCheckboxes.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/admin/cinema/deleteAll', // Thay thế bằng tuyến đường xử lý xoá của bạn
                                data: {
                                    ids: selectedIds,
                                    _token: '{{ csrf_token() }}',
                                },
